...
// import Img from "../../img/aboutUs/about.jpg";
      ...
      <div className="container">
        <section className="about" id="About">
          <div className="row__about">
            <h1>Privacy Policy for MERN</h1>

            <p className="about__p">
              At www.mern.com, accessible from https://mern.com/, one of our
              ...
              and recorded by www.mern.com and how we use it.
            </p>
            ...
            <p className="about__p">
              ...
              that they shared and/or collect in www.mern.com. This policy is
            ...
            <p className="about__p">
              www.mern.com follows a standard procedure of using log files.
            ...
            <p className="about__p">
              Like any other website, www.mern.com uses 'cookies'. These cookies
            ...
            <p className="about__p">
              ...
              the advertising partners of www.mern.com.
            </p>

            <p className="about__p">
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on www.mern.com,
            ...
            <p className="about__p">
              Note that www.mern.com has no access to or control over these
            ...
            <p className="about__p">
              www.mern.com's Privacy Policy does not apply to other advertisers
            ...
            <p className="about__p">
              www.mern.com does not knowingly collect any Personal Identifiable
